...
# (not sure remove) area_base missingness: 0.99 (Base unfinished and finished area)
...
# (not sure remove) framing: 0.99 (The building framing type (steel frame, wood frame, concrete/brick))
